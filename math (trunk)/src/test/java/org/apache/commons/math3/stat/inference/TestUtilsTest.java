...
public class TestUtilsTest {
    ...
    public void testKSTwoSample() throws Exception {
        ...
        //Assert.assertEquals(0.105577085453247, TestUtils.kolmogorovSmirnovTest(smallSample1, smallSample2, false), tol);
        final double d = TestUtils.kolmogorovSmirnovStatistic(smallSample1, smallSample2);
        //Assert.assertEquals(0.5, d, tol);
        //Assert.assertEquals(0.105577085453247, TestUtils.exactP(d, smallSample1.length,smallSample2.length, false), tol); 
    }
}
